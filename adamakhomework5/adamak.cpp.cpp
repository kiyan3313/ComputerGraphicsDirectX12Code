...
ID3DXMesh* Objects[17] = {0, 0, 0, 0};
D3DXMATRIX  Worlds[17];
D3DMATERIAL9 Mtrls[17];
// Assuming d3dUtility.h has this:
...
bool Setup()
{
	...
	//(Device, 0.3f, 0.1f, 1.5f, 20, 20, &Objects[3], 0);
	//D3DXCreateCylinder(Device, 0.3f, 0.1f, 1.5f, 20, 20, &Objects[4], 0);
	...
	D3DXMatrixTranslation(&Worlds[2], 0.0f, .0f, 0.0f);
	D3DXMatrixTranslation(&Worlds[3], 1.4f, - 1.0f, -0.2f);
	D3DXMatrixTranslation(&Worlds[4], -1.4f, -1.0f, -0.2f);
	D3DXMatrixTranslation(&Worlds[5], 0.4f, 2.0f, -1.0f);
	D3DXMatrixTranslation(&Worlds[6], -0.4f, 2.0f, -1.0f);
	D3DXMatrixTranslation(&Worlds[7], 0.8f, -2.0f, -0.15f);
	D3DXMatrixTranslation(&Worlds[8], -0.8f, -2.0f, -0.15f);
	D3DXMatrixTranslation(&Worlds[9], 0.02f, 1.5f, -0.9f);
...
bool Display(float timeDelta)
{
	if (Device)
	{
		...
		D3DXVECTOR3 position(cosf(angle) * 15.0f, height, sinf(angle) * 15.0f);
